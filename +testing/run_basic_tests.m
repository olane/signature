function result = run_basic_tests(match_file_function, get_song_name_function, database_filename, test_clips_folder, input_folder, scoring_mode, clip_length, m)
