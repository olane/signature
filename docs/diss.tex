...
\begin{figure}[p]
    ...
    \caption{Results for additive noise tests on both algorithms, using gaussian white noise. Each line represents a different clip length.}
    \label{fig:gaussian_philips}
\end{figure}
...
\begin{figure}[p]
    ...
    \caption{Results for additive noise tests on both algorithms, using real world noise. Each line represents a different clip length.}
    \label{fig:gaussian_philips}
\end{figure}
