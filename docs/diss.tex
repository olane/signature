...
The second phase, finding the local maxima, is not well described in the original paper. After some research on methods for finding local maxima in 2D signals, I settled on a three pass method. 
